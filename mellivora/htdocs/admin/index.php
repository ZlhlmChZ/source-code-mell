...
section_subhead('Instances Administration Panel (' . $_SESSION['IName'].')');
...
$categories = db_query_fetch_all('SELECT * FROM categories WHERE instanceID = '.$_SESSION["IID"].' ORDER BY title');
