...
{	//var PID = 245;
    var requestURL = "https://cyber-range.sit.nyp.edu.sg:8443/ToasterWars/ProbRetreive?PID=" + databaseID;
...
function getAllProblemInfo()
{
    ...
    var requestURL = "https://cyber-range.sit.nyp.edu.sg:8443/ToasterWars/ProbRetreive?" + $('#UID').val();
	var requestURL = ""
    $.ajax({
        type: 'GET',
        url: requestURL,
...
function getProblemState(databaseID)
{
    ...
    var requestURL = "https://cyber-range.sit.nyp.edu.sg:8443/ToasterWars/ProbSubmit?PID=" + databaseID + "&UID=" + $('#UID').html();
    $.ajax({
        type: 'GET',
        url: requestURL,
        async: false,
...
{	
    $("#problemsubmit").click(function(){
		...
		var requestURL = "https://cyber-range.sit.nyp.edu.sg:8443/ToasterWars/ProbSubmit2?pid=" + pid + "&key=" + key + "&UID=" + $("#UID").text();
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                ig.gm.currentLevel.onSubmit(res.status, res.message);
            },
            error: function(data)
            {
