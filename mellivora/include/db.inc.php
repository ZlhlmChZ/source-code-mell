...
function db_insert_manual ($query) {
    $db = get_global_db_pdo();
...
function question_replication($title, $id){
   
     
     if($title == "Misc."){

db_insert_manual('insert into challenges (category,added, added_by, title, description, available_from, available_until, flag, case_insensitive, automark, points, num_attempts_allowed, min_seconds_between_submissions, relies_on, pid, status, hint) select '.$id.' as category, added, added_by, title, description, available_from, available_until, flag, case_insensitive, automark, points, num_attempts_allowed, min_seconds_between_submissions, relies_on, pid, status, hint from challenges WHERE category = 3');
        }
   else if($title == "Forensics"){

db_insert_manual('insert into challenges (category,added, added_by, title, description, available_from, available_until, flag, case_insensitive, automark, points, num_attempts_allowed, min_seconds_between_submissions, relies_on, pid, status, hint) select '.$id.' as category, added, added_by, title, description, available_from, available_until, flag, case_insensitive, automark, points, num_attempts_allowed, min_seconds_between_submissions, relies_on, pid, status, hint from challenges WHERE category = 4');
        }
   else  if($title == "Data Manipulation"){

db_insert_manual('insert into challenges (category,added, added_by, title, description, available_from, available_until, flag, case_insensitive, automark, points, num_attempts_allowed, min_seconds_between_submissions, relies_on, pid, status, hint) select '.$id.' as category, added, added_by, title, description, available_from, available_until, flag, case_insensitive, automark, points, num_attempts_allowed, min_seconds_between_submissions, relies_on, pid, status, hint from challenges WHERE category = 6');
        }
   else  if($title == "Networking"){

db_insert_manual('insert into challenges (category,added, added_by, title, description, available_from, available_until, flag, case_insensitive, automark, points, num_attempts_allowed, min_seconds_between_submissions, relies_on, pid, status, hint) select '.$id.' as category, added, added_by, title, description, available_from, available_until, flag, case_insensitive, automark, points, num_attempts_allowed, min_seconds_between_submissions, relies_on, pid, status, hint from challenges WHERE category = 7');
        }
   else  if($title == "Malware"){

db_insert_manual('insert into challenges (category,added, added_by, title, description, available_from, available_until, flag, case_insensitive, automark, points, num_attempts_allowed, min_seconds_between_submissions, relies_on, pid, status, hint) select '.$id.' as category, added, added_by, title, description, available_from, available_until, flag, case_insensitive, automark, points, num_attempts_allowed, min_seconds_between_submissions, relies_on, pid, status, hint from challenges WHERE category = 9');
        }
