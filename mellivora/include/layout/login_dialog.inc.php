            ...
            <div class="modal-content">
                <form id="login-dialog-form" method="post" class="form-signin" action="/actions/login">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Log in ('.$_SESSION["IName"].')</h4>
                    </div>
                    <div class="modal-body">
                            <input name="',md5(CONFIG_SITE_NAME.'USR'),'" id=email type="email" class="form-control" placeholder="Email address" required autofocus />
